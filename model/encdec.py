...
class EncDec(nn.Module):
    ...
    def forward(self, data, train=True):
        ...
        if train:
            ...
            tgt_len = data["tgt_len"][perm_index]
            return self.compute_loss(encoder_outputs, decoder_hidden, tgt, tgt_len)
        else:
            return self.beam_search(encoder_outputs, decoder_hidden)

    def compute_loss(self, encoder_outputs, initial_hidden, tgt, tgt_len):
        ...
        for t in range(MAX_TGT_LEN):
            ...
            if loss_name == "mmi":
                ut_decoder_output, ut_decoder_hidden = self.decoder(
                    decoder_input, ut_decoder_hidden, encoder_outputs
                )
